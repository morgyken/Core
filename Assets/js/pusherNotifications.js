(function ($, window, document, undefined) {
    ...
    $.extend(pusherNotifications.prototype, {
        ...
        init: function () {
            ...
            this.pusherChannel = this.pusher.subscribe('dervis.notifications.' + this.settings.loggedInUserId);

            this.pusherChannel.bind('Ignite\\Messaging\\Events\\BroadcastNotification', function (message) {
