...
namespace Ignite\Core\Scaffold\Module;

use Illuminate\Contracts\Config\Repository;
use Illuminate\Contracts\Console\Kernel;
use Illuminate\Filesystem\Filesystem;
use Ignite\Core\Scaffold\Module\Exception\ModuleExistsException;
use Ignite\Core\Scaffold\Module\Generators\EntityGenerator;
use Ignite\Core\Scaffold\Module\Generators\FilesGenerator;
use Ignite\Core\Scaffold\Module\Generators\ValueObjectGenerator;
...
class ModuleScaffold {
    ...
    Filesystem $finder, Repository $config, EntityGenerator $entityGenerator, ValueObjectGenerator $valueObjectGenerator, FilesGenerator $filesGenerator
    ) {
