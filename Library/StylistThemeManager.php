...
class StylistThemeManager implements ThemeManager {
    ...
    private function getThemeInfoForPath($directory) {
        ...
        $theme = new Theme(
                $themeJson->getJsonAttribute('name'), $themeJson->getJsonAttribute('description'), $directory, $themeJson->getJsonAttribute('parent')
        );
    ...
    private function getStatus(Theme $theme) {
        ...
        return mconfig('core.core.admin-theme') === $theme->getName();
    }
